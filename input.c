...
int keycodes[19][5]={{0x4D,0x64,0,0,0},		/* 1 Right */
                     {0x48,0x61,0,0,0},		/* 1 Up */
                     {0x4B,0x63,0,0,0},		/* 1 Left */
                     {0x50,0x66,0,0,0},		/* 1 Down */
                     {0x3B,0x1C,0x5A,0,0},	/* 1 Fire */
                     {0x20,0,0,0,0},		/* 2 Right */
                     {0x11,0,0,0,0},		/* 2 Up */
                     {0x1E,0,0,0,0},		/* 2 Left */
                     {0x1F,0,0,0,0},		/* 2 Down */
                     {0x0F,0,0,0,0},		/* 2 Fire */
                     {0x14,0,0,0,0},		/* Cheat */
                     {0x4E,0,0,0,0},		/* Accelerate */
                     {0x4A,0,0,0,0},		/* Brake */
                     {0x41,0,0,0,0},		/* Music */
                     {0x43,0,0,0,0},		/* Sound */
                     {0x58,0,0,0,0},		/* Exit */
